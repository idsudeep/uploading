            ...
            <div class="col-md-3 p-0">
                <div class="left-navbar">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item" onclick="showReports()">Transactions</li>
...
<a class="dropdown-item" href="addproduct.php?ptype=<?php echo $row['CategoryID']; ?>">add Product</a>
<a class="dropdown-item" href="updateproduct.php?ptype=<?php echo $row['CategoryID']; ?>">update Product</a>
<a class="dropdown-item" href="vproduct.php?ptype=<?php echo $row['CategoryID']; ?>">View Product</a>
